...
public class SecondsR {
    ...
    public SecondsR(Date create_time, Date update_time, Integer buy_price, Integer sell_price, String detail, Integer flag, String title, String image,
