...
public class AddressController {
    ...
    @GetMapping("list")
    public ResponseEntity<PageResult<Address>> queryAddress(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        PageResult<Address> result = this.addressService.queryAddress(brandQueryByPageParameter);
        if(result == null){
