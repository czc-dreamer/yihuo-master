package com.yihuo.order.controller;
...
import com.yihuo.order.utils.PayHelper;
import com.yihuo.order.utils.PayState;
...
public class OrderController {
    ...
    public ResponseEntity<Void> deleteOrderById(@PathVariable("id") String ids){
        String separator="-";
        if (ids.contains(separator)){
            ...
            this.orderService.deleteOrder(Long.parseLong(ids));
        }
    ...
    public ResponseEntity<Void> updateUser(@RequestBody Order order){
