...
import com.yihuo.order.client.GoodsClient;
import com.yihuo.order.interceptor.LoginInterceptor;
import com.yihuo.order.mapper.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Boolean updateOrderStatus(Long id, Integer status) {
        UserInfo userInfo = LoginInterceptor.getLoginUser();
        Long spuId = this.goodsClient.querySecondsById(findGoodsIdByOrderId(id)).getId();
     ...
     * @return
     */
    public Long findGoodsIdByOrderId(Long id) {
        Example example = new Example(OrderDetail.class);
        example.createCriteria().andEqualTo("orderId", id);
        List<OrderDetail> orderDetail = this.orderDetailMapper.selectByExample(example);
