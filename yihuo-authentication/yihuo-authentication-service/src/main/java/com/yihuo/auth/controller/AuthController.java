package com.yihuo.auth.controller;
...
import com.yihuo.utils.CookieUtils;
...
public class AuthController {
     ...
     */
    @GetMapping("verify")
    public ResponseEntity<UserInfo> verifyUser(@CookieValue("YH_TOKEN") String token,HttpServletRequest request,
                                               HttpServletResponse response){
        try{
            //1.从token中解析token信息
