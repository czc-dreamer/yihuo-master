...
import com.yihuo.service.GoodsHtmlService;
import com.yihuo.service.GoodsService;


import com.yihuo.utils.ThreadUtils;
...
public class GoodsHtmlServiceImpl implements GoodsHtmlService {
    ...
    public void createHtml(Long spuId) throws InterruptedException, ExecutionException {
        ...
        //创建输出流
        File file = new File("/Users/chenzhaocun/myCode/校园二手/html/item"+spuId+".html");
        try {
    ...
    public void deleteHtml(Long id) {
        File file = new File("/Users/chenzhaocun/myCode/校园二手/html/item"+id+".html");
        file.deleteOnExit();
    }
}
