package com.yihuo.cart.service.impl;

import com.yihuo.auth.entity.UserInfo;
import com.yihuo.cart.client.GoodsClient;
import com.yihuo.cart.interceptor.LoginInterceptor;
import com.yihuo.cart.pojo.Cart;
import com.yihuo.cart.service.CartService;
...
public class CartServiceImpl implements CartService {
    ...
    private static String KEY_PREFIX = "yihuo:cart:uid:";
    ...
    public void addCart(Cart cart) {
        ...
        if (result){
            ...
            //8.其他商品信息，需要查询商品微服务
            SecondsD sku = this.goodsClient.querySkuById(skuId);
            cart.setImage(StringUtils.isBlank(sku.getImage()) ? "" : StringUtils.split(sku.getImage(),",")[0]);
            cart.setPrice(sku.getSell_price());
            cart.setTitle(sku.getTitle());
            cart.setOwnSpec(sku.getDetail());
        }
        //9.将购物车数据写入redis
